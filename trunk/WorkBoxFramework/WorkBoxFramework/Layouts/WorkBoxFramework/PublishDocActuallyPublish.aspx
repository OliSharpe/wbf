...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublishDocActuallyPublish.aspx.cs" Inherits="WorkBoxFramework.Layouts.WorkBoxFramework.PublishDocActuallyPublish" DynamicMasterPageFile="~masterurl/default.master" %>
...
<script type="text/javascript">
    ...
    function WorkBoxFramework_triggerPublishNextDocument() {
        //alert("In trigger next publicshing step");
        
        // First let's resize the modal dialog given the new content:
//        var currentModal = SP.UI.ModalDialog.get_childDialog();
//        currentModal.$$d_autoSize();

        // Then trigger the AJAX call for the next bit of publishing:
...
<asp:LinkButton ID="HiddenSubmitLink" Text="Publish Next" OnClick="PublishNextDocument" runat="server" style="display:none;" />

<asp:UpdatePanel ID="PublishDocumentsPanel" runat="server" UpdateMode="Always">
...
<asp:PlaceHolder ID="DocumentPublishingProgress" runat="server" />

</div>

<asp:Label ID="PublishingProcessJSON" runat="server" style="display: none; "/>
...
<script type="text/javascript">
    WorkBoxFramework_triggerPublishNextDocument();
</script>
