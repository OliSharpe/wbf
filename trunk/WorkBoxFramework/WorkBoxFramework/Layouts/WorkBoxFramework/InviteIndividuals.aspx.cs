...
{
    public partial class InviteIndividuals : WorkBoxDialogPageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                InvolvedIndividualsControl.WBxInitialise(WorkBox.InvolvedIndividuals);
                VisitingIndividualsControl.WBxInitialise(WorkBox.VisitingIndividuals);
            }
        }
