...
{
    public partial class ViewWorkBoxLibraryWebPartUserControl : UserControl
    {
        protected ViewWorkBoxLibraryWebPart webPart = default(ViewWorkBoxLibraryWebPart);
        ...
        {
            webPart = this.Parent as ViewWorkBoxLibraryWebPart;

            showStatusFilter = webPart.ShowStatusFilterSelector;
        ...
        private String SelectedWorkBoxStatusFilter
        {
            get
            {
                if (!String.IsNullOrEmpty(webPart.WorkBoxStatusFilter))
                {
                    return webPart.WorkBoxStatusFilter;
                }
                ...
                {
                    currentStatusFilter = Request.QueryString["Status"];
