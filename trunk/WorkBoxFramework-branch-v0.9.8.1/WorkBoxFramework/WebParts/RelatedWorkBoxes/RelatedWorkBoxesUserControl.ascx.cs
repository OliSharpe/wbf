...
{
    public partial class RelatedWorkBoxesUserControl : UserControl
    {
        protected RelatedWorkBoxes webPart = default(RelatedWorkBoxes);

        protected void Page_Load(object sender, EventArgs e)
        {
            webPart = this.Parent as RelatedWorkBoxes;
