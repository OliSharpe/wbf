...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActuallyKeepRecords.aspx.cs" Inherits="WorkBoxFramework.Layouts.WorkBoxFramework.ActuallyKeepRecords" DynamicMasterPageFile="~masterurl/default.master" %>
...
<script type="text/javascript">
    ...
    function WorkBoxFramework_triggerKeepNextDocument() {
...
<h2>Keeping these Records</h2>

<p>
The records(s) selected will now be marked to review at a later date</p>
...
<asp:PlaceHolder ID="RecordKeepingProgress" runat="server" />

</div>

<asp:Label ID="NextRecordToKeep" runat="server" style="display: none; "/>
...
<script type="text/javascript">
    WorkBoxFramework_triggerKeepNextDocument();
</script>
