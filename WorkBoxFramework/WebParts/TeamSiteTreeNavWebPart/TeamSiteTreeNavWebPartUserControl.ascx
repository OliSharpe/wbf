...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TeamSiteTreeNavWebPartUserControl.ascx.cs" Inherits="WorkBoxFramework.WebParts.TeamSiteTreeNavWebPart.TeamSiteTreeNavWebPartUserControl" %>
